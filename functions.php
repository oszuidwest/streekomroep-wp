...
function zw_add_videojs()
{
    ...
    wp_enqueue_style('video.js', 'https://cdnjs.cloudflare.com/ajax/libs/video.js/8.13.0/video-js.min.css');
    wp_enqueue_script('video.js', 'https://cdnjs.cloudflare.com/ajax/libs/video.js/8.13.0/video.min.js', args:['strategy'  => 'defer']);
    wp_enqueue_script('video.js.nl', 'https://cdnjs.cloudflare.com/ajax/libs/video.js/8.13.0/lang/nl.min.js', args:['strategy'  => 'defer']);
}
